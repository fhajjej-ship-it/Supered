...
test("GitHub Pages landing page is present and product-focused", async () => {
  ...
  assert.match(html, /codex plugin marketplace add fhajjej-ship-it\/Supered --ref v0\.7\.0/);
...
test("README has launch badges and a Pages link", async () => {
  ...
  assert.match(readme, /codex plugin marketplace add fhajjej-ship-it\/Supered --ref v0\.7\.0/);
